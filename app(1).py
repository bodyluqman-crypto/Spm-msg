...
class FF_CLient():
            ...
            if hasattr(self, 'CliEnts2') and self.CliEnts2:
                ...
                if hasattr(self, 'DaTa2') and len(self.DaTa2.hex()) > 4 and '0500' in self.DaTa2.hex()[0:4]:
                    ...
                    if '5' in dT and 'data' in dT["5"]:
                        ...
                        if '17' in dT["5"]["data"] and 'data' in dT["5"]["data"]["14"]:
                            sq = dT["5"]["data"]["17"]["data"]
                        else:
                            sq = "1"
    ...
    def MajorLogin(self , Access_ToKen , Access_Uid):
        ...
        self.dT = bytes.fromhex('')
...
x7mhhhhhh = [
    {"id":"4291513313","password":"S1X_MASRY-EWEJP9KIR"},
    {'id':'4291516568','password':'S1X_MASRY-WZPCV731L'},
    {'id': '4291516751', 'password': 'S1X_MASRY-HR1JR5CN7'},    
    {'id': '4291516938', 'password': 'S1X_MASRY-THAKEHK2F'},
    {'id': '4291522961', 'password': 'S1X_MASRY-YJSFXS0AL'}
]
